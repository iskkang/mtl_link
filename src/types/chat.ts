...
export interface MessageWithSender extends Message {
  sender:        Pick<Profile, 'id' | 'name' | 'avatar_url' | 'avatar_color' | 'is_bot' | 'presence_status' | 'status_message'> | null
...
export interface RoomListItem extends Room {
  members:      (Pick<Profile, 'id' | 'name' | 'avatar_url' | 'avatar_color' | 'preferred_language' | 'is_bot' | 'presence_status' | 'status_message'> & { last_read_at: string | null })[]
  unread_count: number
  is_pinned:    boolean
  is_muted:     boolean
