  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-h-0 p-4 flex flex-col gap-3">
        ...
        <div className="grid grid-cols-3 gap-3 flex-shrink-0" style={{ height: '165px', gridTemplateRows: '1fr', overflow: 'hidden' }}>
          <GreetingCard />
        ...
        <div className="grid grid-cols-3 gap-3 flex-shrink-0" style={{ height: '192px', gridTemplateRows: '1fr', overflow: 'hidden' }}>
          <NewsCard />
          <DisasterCard />
          <PortTop5Card />
        </div>
